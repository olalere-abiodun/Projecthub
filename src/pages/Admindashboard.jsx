            ...
            <main className="flex-1 flex flex-col">
                ...
                <section className=" flex-1 p-[32px]">
                    ...
                    <div className="grid grid-cols-[2fr_1fr_1fr] gap-6 h-[192px] mt-[48px] mb-[48px]">
                        <div class=" p-[32px] h-[164px] rounded-[12px] border-l-4 border-[#2563EB] shadow">
                            <h2 className="text-[16px] font-bold text-[#434655] tracking-[1.6px]">TOTAL SUBMISSIONS</h2>
                            <div>
                                <h1 className="flex flex-col gap-2 text-[60px] font-extrabold text-[#004AC6] tracking-[-3px]">
                                    24
                                </h1>
                        ...
                        <div class="bg-[#F3F4F6] p-[32px] rounded-[12px] flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <div class="h-1 bg-[#d9d9d9] overflow-hidden rounded">
                                  <div class="progress-bar"></div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-[#F3F4F6] p-[32px] rounded-[12px] flex flex-col gap-4">
                            <h2 className="text-[16px] font-bold text-[#434655] tracking-[1.6px]">DEPARTMENT REACH</h2>
                            <div>
                                <h1 className="flex flex-col gap-2 text-[36px] font-extrabold text-[#191C1E]">
                                    12
                                </h1>
                                <p className="text-[#434655] font-semibold text-[12px]">Active departments</p>
                            </div>
                        </div>
                    </div>
                    <div>
